...
public class PasswordInputView extends EditText{
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        ...
        final int defaultBorderColor = res.getColor(R.color.colorE3E3E3);//线的颜色
        final float defaultBorderWidth = res.getDimension(R.dimen.width_1dp);
        final float defaultBorderRadius = res.getDimension(R.dimen.width_6dp);

        final int defaultPasswordLength = 6;
        final int defaultPasswordColor = res.getColor(R.color.colorBlack);
        final float defaultPasswordWidth = res.getDimension(R.dimen.width_6dp);
        final float defaultPasswordRadius = res.getDimension(R.dimen.width_6dp);
