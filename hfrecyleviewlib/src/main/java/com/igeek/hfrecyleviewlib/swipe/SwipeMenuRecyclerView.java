...
import com.igeek.hfrecyleviewlib.swipe.touch.DefaultItemTouchHelper;
import com.igeek.hfrecyleviewlib.swipe.touch.OnItemMoveListener;
import com.igeek.hfrecyleviewlib.swipe.touch.OnItemMovementListener;
import com.igeek.hfrecyleviewlib.swipe.touch.OnItemStateChangedListener;
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                break;
            case MotionEvent.ACTION_UP:
                float dy = Math.abs(e.getY() - mDownPoint.y);
                float dx = Math.abs(e.getX() - mDownPoint.x);
                if (dy > dx && dy > mScaleTouchSlop) {
                    if (e.getY() < mDownPoint.y) {
                        loadMore = true;
                    } else {
                        loadMore = false;
                    }
